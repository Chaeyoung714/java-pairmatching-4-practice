...
public class InputView {
    ...
    public List<String> inputLessonChoice() {
        System.out.println("과정, 레벨, 미션을 선택하세요." + System.lineSeparator()
                + "ex) 백엔드, 레벨1, 자동차경주");
        String choices = Console.readLine();
        validateLessonChoiceInput(choices);
        return new ArrayList<>(List.of(choices.split(", ")));
    }

    private void validateLessonChoiceInput(String choices) {
    ...
    public String inputRematch() {
        System.out.println(System.lineSeparator() + "매칭 정보가 있습니다. 다시 매칭하시겠습니까?"
